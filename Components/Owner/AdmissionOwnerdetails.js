...
import { API_COURSE,API_OWNERDETAILSDATA } from '../../APILIST/APILIST';

export function AdmissionOwnerDetails({route,navigation}) {
    
    const typePass = route['params']['type']
    ...
    const fetchdata = async (jsonval) =>{
        const resp = await fetch(API_OWNERDETAILSDATA,{
            method: 'POST',
            headers: {
        ...
        <View style={{flex:1,backgroundColor:'#fff'}}>
            ...
            <View style={styles.headerPad}>
                <View style={styles.headpadCss}>
                    ...
                    <View style={{width:'60%'}}>
                        <Text style={styles.headerText}>Consultant Details</Text>
                    </View>
